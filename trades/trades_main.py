...
main_window_start, main_window_len, main_window_sum = logic.longest_window(transactions)
division = logic.dividing_window_by_markets(transactions, market_list, main_window_start, main_window_len)
windows_by_markets = logic.longest_windows_by_markets(transactions, market_list)
print("Main window")
print(main_window_start, main_window_len, main_window_sum)
